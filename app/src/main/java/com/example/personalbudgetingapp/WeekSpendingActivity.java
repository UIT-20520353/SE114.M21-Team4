...
public class WeekSpendingActivity extends AppCompatActivity {
    ...
    private TextView totalWeekAmountSpendOn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalWeekAmountSpendOn = findViewById(R.id.totalWeekAmountTextView);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    totalWeekAmountSpendOn.setText("Total Month's Spending: $" + totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    totalWeekAmountSpendOn.setText("Total Week's Spending: $" + totalAmount);
                }
            }
